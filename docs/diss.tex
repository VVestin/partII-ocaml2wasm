...
Now, we're going to dive a bit deeper into how WebAssembly works for reference in laters chapters.
...
type IntTree = Leaf | Branch of IntTree * int * IntTree \end{verbatim}
   ...
   \item
      Pattern matching using {\tt match-with}. This is key because it's the only way to estructure tuple and variant types. Full patterns should be supported.
