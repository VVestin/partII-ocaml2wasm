...
\PassOptionsToPackage{hyphens}{url}\usepackage[pdfborder={0 0 0}]{hyperref}    % turns references into hyperlinks
...
\bigskip
\leftline{Signed Weston Metzler}

\medskip
\leftline{Date 13/5/2021}
