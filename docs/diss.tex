...
Disguising complexity is far more dangerous than exposing it, and a can cause some difficult to diagnose issues that break the type system.
This is a strong contrast with OCaml where entirely different operators are used on ints and floats and explicit conversion is needed to mix types at all.
